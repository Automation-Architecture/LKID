...
const SPRINTS = [
  ...
  { name: "Sprint 4 — Tokenized Flow", start: "2026-04-19", end: "2026-04-20" },
  { name: "Sprint 5 — Launch Readiness", start: "2026-04-20", end: "2026-05-04" },
];

const PROJECT_START = new Date("2026-03-20");
const PROJECT_END = new Date("2026-05-04");
