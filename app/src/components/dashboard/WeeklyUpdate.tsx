...
Looking ahead, Sprint 2 (April 6-10) builds the core flow: Clerk authentication integration, database setup on Railway, the FastAPI prediction endpoint implementing your algorithm, the real chart with all four trajectory lines, and the end-to-end form-to-chart pipeline.`,
