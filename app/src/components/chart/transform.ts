  ...
  const trajectoryData: TrajectoryData[] = [
    {
      ...
      finalEgfr: trajectories.bun_12[trajectories.bun_12.length - 1] ?? egfr_calculated,
      dialysisAge: dial_ages.bun_12,
    },
    {
      ...TRAJECTORY_CONFIG.bun_13_17,
      points: zipPoints(trajectories.bun_13_17, time_points_months),
      finalEgfr: trajectories.bun_13_17[trajectories.bun_13_17.length - 1] ?? egfr_calculated,
      dialysisAge: dial_ages.bun_13_17,
    },
    {
      ...TRAJECTORY_CONFIG.bun_18_24,
      points: zipPoints(trajectories.bun_18_24, time_points_months),
      finalEgfr: trajectories.bun_18_24[trajectories.bun_18_24.length - 1] ?? egfr_calculated,
    ...
    },
    {
      ...
      finalEgfr: trajectories.no_treatment[trajectories.no_treatment.length - 1] ?? egfr_calculated,
...
export const MOCK_PREDICT_RESPONSE: PredictResponse = {
  ...
  dial_ages: { no_treatment: 68, bun_18_24: null, bun_13_17: null, bun_12: null },
  slope: -3.2,
