/**
 * Sentry edge-runtime initialization (LKID-72).
 *
 * Loaded by `instrumentation.ts#register()` when NEXT_RUNTIME === "edge".
 * Covers the `src/proxy.ts` Clerk auth proxy (Next.js 16 renamed
 * middleware.ts -> proxy.ts) and any edge-runtime route handlers.
 */
