...
- Project timeline bar: `Mar 20 - Apr 9` with a "You are here" marker at current date
...
- Sprint 2 preview: "Core Flow (Mar 26 – Apr 2)" — auth, DB, API, prediction engine, chart
- Sprint 3 preview: "Polish & QA (Apr 2 – Apr 9)" — PDF export, disclaimers, accessibility, final QA
- Ship date callout: "Target launch: April 9, 2026"
